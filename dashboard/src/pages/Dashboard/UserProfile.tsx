        ...
        <div className={s.ProfileContainer}>
            <div>
                { data &&
                    <>
                        { data.image !== 'none'
                            ? <img src={data.image} className={s.ProfileImage} alt="avatar" />
                            : (
                                <div className={s.ProfileImageContainer}>
                                    <svg className={s.ProfileImage} xmlns="http://www.w3.org/2000/svg" width="50px" height="50px" viewBox="0 0 50 50">
                                        <g className={s.ProfileImageFill} >
                        ...
                        <div className={s.ProfileItemContainer}>
                            <p className={s.ProfileItemTitle}>Name: </p>
                            <p className={s.ProfileItemValue}>{data.name}</p>
                        </div>
                        <div className={s.ProfileItemContainer}>
                            <p className={s.ProfileItemTitle}>E-mail: </p>
                            <p className={s.ProfileItemValue}>{data.email}</p>
                        </div>
                        <div className={s.ProfileItemContainer}>
                            <p className={s.ProfileItemTitle}>Web-sites: </p>
                            <p className={s.ProfileItemValue}>{data.email}</p>
                        </div>
                    </>
                }
