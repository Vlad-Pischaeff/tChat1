        ...
        <div className={s.Container}>
            <div>
                { data &&
                    <>
                        { data.image !== 'none'
                            ? <img src={data.image} className={s.Image} alt="avatar" />
                            : (
                                <div className={s.ImageContainer}>
                                    <svg className={s.Image} xmlns="http://www.w3.org/2000/svg" width="50px" height="50px" viewBox="0 0 50 50">
                                        <g className={s.ImageFill} >
